...
2. Audit the project docs for stale or inconsistent behavior, especially `README.md`, `CHANGELOG.md`, `CLAUDE.md`, `doc/development.md`, `doc/user-guide.md`, `doc/api.md`, `doc/troubleshooting.md`, `doc/TODOs.md`, `samples/README.md`, and relevant code comments.
...
5. Commit documentation changes using the `commit-and-push` skill, grouped by topic.
